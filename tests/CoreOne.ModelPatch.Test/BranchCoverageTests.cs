...
public class BranchCoverageTests : Disposable
{
    ...
    public void ProcessedModelExtensions_Count_WithNullPredicate()
    {
        ...
        collection.GetType().GetMethod("Add", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)!
    ...
    {
        var collection = new ProcessedModelCollection();
        var addMethod = collection.GetType().GetMethod("Add", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)!;
    ...
    public void ProcessedModelCollection_AddRange()
    {
        ...
        var addMethod = collection1.GetType().GetMethod("Add", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)!;
        var addRangeMethod = collection1.GetType().GetMethod("AddRange", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)!;
    ...
    {
        var result = new Result<ProcessedModelCollection>(new ProcessedModelCollection());
        var addMethod = result.Model!.GetType().GetMethod("Add", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance)!;
